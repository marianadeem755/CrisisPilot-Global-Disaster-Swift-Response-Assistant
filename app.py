...
st.sidebar.info("📢 **Real-Time Alerts Delivered via:** **🚨 Discord**")
...
<div style="text-align: center; margin: 20px 0;">
    <a href="https://discord.gg/ffGSRJrT" 
...
tab1, tab2, tab3, tab4 = st.tabs(["📰📡CrisisPilot: Global Threat Monitor", "💬CrisisPilot: Command Chat Center", "🛡️Smart Survival Guide", "📊🔧Emergency Action Toolkit"])
